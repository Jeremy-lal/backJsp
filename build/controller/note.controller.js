...
exports.NoteController = function (app) {
    ...
    if (environment_1.environment.JWT_SECRET) {
        noteRouter.use(jwt({ secret: environment_1.environment.JWT_SECRET }));
    }
    else {
        throw new Error('Secret is not defined');
    }
    noteRouter.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, noteService.getAll()];
                case 1:
                    result = _a.sent();
                    res.send(result);
                    return [3 /*break*/, 3];
    ...
    noteRouter.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, noteService.findByUserId(id)];
                case 2:
                    result = _a.sent();
                    res.send(result);
                    return [3 /*break*/, 4];
    ...
    app.use(environment_1.environment.baseUrl + '/notes', noteRouter);
};
