...
var picture_controller_1 = require("./controller/picture.controller");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    app.use('/src/images', express_1.default.static('images'));
                    app.use(express_1.default.static('/images' + '/public'));
                    app.get('/', function (req, res) {
                        res.sendFile('/images' + '/index.html');
                    });
                    // Ajout des différentes route de votre application
                    user_controller_1.UserController(app);
                    comment_controller_1.CommentController(app);
                    note_controller_1.NoteController(app);
