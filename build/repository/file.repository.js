...
var FileRepository = /** @class */ (function () {
    function FileRepository() {
        this.GET_ALL = 'SELECT * FROM file;';
        this.GET_BY_ID = 'SELECT * FROM file WHERE user_id = ?';
        this.POST_BY_ID = 'INSERT INTO file SET ?';
        this.DEL_BY_ID = 'DELETE FROM file WHERE id = ?';
    ...
    FileRepository.prototype.save = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.query(this.POST_BY_ID, file)];
                    case 1:
                        postfile = _a.sent();
                        return [2 /*return*/, postfile];
                }
            });
        });
    };
